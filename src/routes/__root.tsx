...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Orderan— Order Management System" },
      { name: "description", content: "Internal order management Maualris" },
      { name: "robots", content: "noindex, nofollow" },
      { property: "og:title", content: "Orderan— Order Management System" },
      { name: "twitter:title", content: "Orderan— Order Management System" },
      { property: "og:description", content: "Internal order management Maualris" },
      { name: "twitter:description", content: "Internal order management Maualris" },
