...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MAULARIS — Order Management System" },
      { name: "description", content: "Internal order management Maularis" },
      { name: "robots", content: "noindex, nofollow" },
      { property: "og:title", content: "MAULARIS — Order Management System" },
